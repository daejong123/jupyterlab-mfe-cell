...
import ChoiceComponent, { MfeObj, ChoiceType } from './components/ChoiceComponent';
    ...
    render() {
        ...
        return (
            <div>
                ...
                <TransitionGroup>
                    {
                        mfeObjs.filter(item => item).map((item: MfeObj, index: number) =>
                            (
                                <CSSTransition
                                    classNames="fade"
                                    timeout={500}
                ...
                <div className='vertical-horizon-center-container' style={{ marginTop: '50px' }}>
